...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'في اي بي'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙿")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'في اي بي') 
local DRAGON_Msg = { 
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "في اي بي")
tdcli_function ({ID = "GetUser",user_id_ = bot_id,},function(arg,data) 
...
local Text =[[
🫀𖤟 ᗯEᒪᑕOᗰE  TO  SOᑌᖇᑕE ᐯIᑭ ‌𖠧
           ⁨࿈『⌯﮼ SOᑌᖇᑕE ᐯIᑭ ﮼⌯』࿈⁩  
🫀𖤟 ᑭᗰ ᗰE TO ᗰᗩKE YOᑌᖇ Oᗯᑎ OᑎE 𖠧
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = ' HＩＡＶＥＥＮ ', url = "https://t.me/BelalElshayal"},{text = ' ᗰ ᗩ G I ᗪ ', url = "https://t.me/SA_FO_RA_7"},
},
{
{text = ' KＨＡＬＥＤ ', url = "https://t.me/Elskraaan"},
},
{
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '   ⌯ HＩＡＶＥＥＮ 🦅 ⊁  ',url="t.me/H_I_v_e_e_n101"}},
{{text = '  ⌯ ᗰ ᗩ G I ᗪ 🦅 ⊁ ',url="t.me/MAGID_ALI_10"}},
{{text = '  ⌯ KＨＡＬＥＤ 🦅 ⊁ ',url="t.me/UU_K2"}},
{{text = ' ＳＯＵＲＣＥ ＶＩＰ   ',url="t.me/source_Laren"}},  
...
"تكلم عن نفسك", 
"ليه انت مش سالك", 
"ما هيا عيوب سورس في اي بي؟ ", 
"اخر كتاب قرآته", 
"روايتك المفضله ?", 
"اخر اكله اكلتها", 
"اخر كتاب قرآته", 
"اي رائيك في في اي بي..😂 ", 
"افضل يوم ف حياتك", 
"ليه مضيفتش كل جهاتك", 
"حكمتك ف الحياه", 
"لون عيونك", 
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس في اي بي ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس في اي بي ؟ ", 
"كم مره حبيت؟ ", 
...
if text == 'العاب في اي بي' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
if Get_info then
local TextS = "\n ⋆ اهلا بك في متجر ملفات في اي بي\n ⋆ ملفات السورس ↓\n≪•════•| ՏΌႮᎡᏟᎬ ᏙᎥᏢ |•════•≫\n\n"
...
send(msg.chat_id_, msg.id_," ⋆ عذرا الملف لايدعم سورس في اي بي \n") 
end
return false
end
...
if text == ("مسح قائمه في اي بي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ⋆ تم مسح قائمه في اي بي')
return false
end

if text == 'قائمه في اي بي' and Sudo(msg) then
...
if #list == 0 then
t = " ⋆ لا يوجد احد في قائمه في اي بي"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع في اي بي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local source_Laren = database:get(bot_id..'text:ch:user')
if source_Laren then
send(msg.chat_id_, msg.id_,'['..source_Laren..']')
...
if text and text:match("^رفع في اي بي @(.*)$") and Sudo(msg) then
local username = text:match("^رفع في اي بي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local source_Laren = database:get(bot_id..'text:ch:user')
if source_Laren then
send(msg.chat_id_, msg.id_,'['..source_Laren..']')
...
if text and text:match("^رفع في اي بي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع في اي بي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local source_Laren = database:get(bot_id..'text:ch:user')
if source_Laren then
send(msg.chat_id_, msg.id_,'['..source_Laren..']')
...
if text == ("تنزيل في اي بي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local source_Laren = database:get(bot_id..'text:ch:user')
if source_Laren then
send(msg.chat_id_, msg.id_,'['..source_Laren..']')
...
if text and text:match("^تنزيل في اي بي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل في اي بي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local source_Laren = database:get(bot_id..'text:ch:user')
if source_Laren then
send(msg.chat_id_, msg.id_,'['..source_Laren..']')
...
if text and text:match("^تنزيل في اي بي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل في اي بي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local source_Laren = database:get(bot_id..'text:ch:user')
if source_Laren then
send(msg.chat_id_, msg.id_,'['..source_Laren..']')
...
end --الكود حصري سورس في اي بي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'في اي بي').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه في اي بي') 
return false
end
...
'دوختو '..Namebot..'🤦♥️',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس في اي بي🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
◉ 𝘾𝙃 - [𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙿   ](t.me/source_Laren )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
•════•| ՏΌႮᎡᏟᎬ ᏙᎥᏢ |•════•
⋆ اليك الاوامر الخاص بسورس في اي بي .
