...
keyboard.inline_keyboard = {
{
{text = '𝙷 𝙸 𝙰 ?? 𝙴 𝙴 𝙽.',url="t.me/H_I_v_e_e_n101"},
},
{
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1523435687, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
