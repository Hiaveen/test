...
sudo_users = {SUDO,1726705278,1465250253,1836501705,1767369613,1781270649,1892231097}   
...
var = true  
elseif tonumber(user_id) == tonumber(1781270649) then
var = true  
...
if text == 'سوريا' or text == 'احمد' or text == 'مبرمج السورس' then
local Text = [[
𓆩 اقـــمــــد مــن الـــقــمــدان يـــآروحـــي 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المــبــرمـج سوريـآ',url="t.me/siria22"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'عموري' or text == 'موري' or text == 'المطور عموري' then
local Text = [[
𓆩 كيـنج التليجرام 𓆪
]]
keyboard = {} 
...
if text == 'ميرو' or text == 'مريم' or text == 'مرات سوريا' then
local Text = [[
𓆩 روح قـلب سوريـآ متـقـربش𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✰ مـيـرو✰ ',url="t.me/UUU_OOO1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ابن الساحل' or text == 'علي' or text == 'مرات سوريا' then
local Text = [[
𓆩ابن الساحل قـلب سوريا𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'شـق سوريـا',url="t.me/ABN_ALSAHEL_YAA"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'اصاله' or text == 'بنت سوريا' or text == 'ستك اصاله' then
local Text = [[
𓆩 ستـك اصـآله روح قلب داد سوريا𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اصالـه ✰',url="t.me/SoLaa85"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'حسناء' or text == 'ستك حسناء' or text == 'سونسون' then
local Text = [[
𓆩ملـكة جمال التـلي 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'حسناء',url="t.me/HASNAA824"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
