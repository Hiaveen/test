...
local Sudo_Welcome = '◍اهلا بك مجددا عزيزي المطور \n◍اليك الازرار الخاصه بتعديل وتغيير كلايش سورس  كوين فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'اذاعه خاص','اذاعه بالتثبيت'},
{'اذاعه'},
{'اذاعه بالتوجيه','اذاعه بالتوجيه خاص'},
{'رجوع ،🔙‘'},
}
...
local Sudo_Welcome = '◍اهلا بك مجددا عزيزي المطور \n◍اليك الازرار الخاصه بتعديل وتغيير كلايش سورس  كوين فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'الاشتراك الاجباري','وضع قناه الاشتراك'},
...
if text == '~ قسم تفعيل والتعطيل~' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '◍اهلا بك مجددا عزيزي المطور \n◍اليك الازرار الخاصه بتعديل وتغيير كلايش سورس  كوين فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'الاشتراك الاجباري','وضع قناه الاشتراك'},
