...
keyboard = {}  
keyboard.inline_keyboard = {  
{{text = 'ᴛᴇʟᴇɢʀᴀᴍ ꕤ',url="https://my.telegram.org/auth?to=delete"}},  
{{text = 'ɪɴѕᴛᴀɢʀᴀᴍ ꕤ', url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"}},  
{{text = 'ғᴀᴄᴇʙᴏᴏᴋ ꕤ', url="https://www.facebook.com/help/deleteaccount"}},  
{{text = 'ѕɴѕᴘᴄʜᴀᴛ  ꕤ', url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/magidx&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'حذف حسابي' or text == 'بوت الحذف' then  
local Text = [[  
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = ' 𝙳𝙴𝙻𝙴𝚃𝙴 𝙰𝙽 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 ⤶ ',url="t.me/LC6BOT"}},
...
if Text == '/game2' then
local Teext =[[
 🦅 اهلا في قائمه الالعاب المتطوره سورس بلح  
...
{{text = 'SkodaHockey1 ', url="https://t.me/gamee?game=SkodaHockey1"},{text = 'SummerLove', url="https://t.me/gamee?game=SummerLove"}},  
{{text = 'SmartUpShark', url="https://t.me/gamee?game=SmartUpShark"},{text = 'SpikyFish3', url="https://t.me/gamee?game=SpikyFish3"}},  
{{text = '💘 ❪SＯＵＲＣＥ❫ 💘', url="t.me/source_Laren"}},
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
