...
{{text = ' ѕɴѕᴘᴄʜᴀᴛ  ⤶   ',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},  
{{text = ' ғᴀᴄᴇʙᴏᴏᴋ ⤶ ',url="t.me/https://www.facebook.com/help/deleteaccount"}},
{{text = ' ɪɴѕᴛᴀɢʀᴀᴍ ⤶ ',url="t.me/https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"}},
