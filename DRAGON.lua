...
if text == 'هيفين' or text == 'احمد' or text == 'مبرمج السورس' then
local Text = [[
◍ مطور السورس .
...
if text == 'مرات هيفين' or text == 'قلبوشه' or text == 'اوليفيا' then
local Text = [[
◍ ستك اوليفيا يقلبمك .
◍ روح قلب هيفين .
]]
...
if text == 'ماجد' or text == 'هكر القلوب' or text == 'ماقد' then
local Text = [[
◍ مطور السورس .
◍ يمكنك التواصل معه عن طريق معرفه .
]]
...
if text == 'خلوده' or text == 'سيان' or text == 'خالد' then
local Text = [[
◍ مطور السورس .
◍ يمكنك التواصل معه عن طريق معرفه .
]]
...
local Text = [[
 ☯اهلا بك في سورس لارين الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ☯
]]
keyboard = {} 
keyboard.inline_keyboard = {
