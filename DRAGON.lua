...
keyboard = {
{'خالد الهكر','ماجد الهكر'},
{'༫═════⛥═════༫'},
{'ʜɪᴀᴠᴇɴ ᴅᴇᴠᴇʟᴏᴘᴇʀ sᴏᴜʀᴄᴇ'},
{'༫═════⛥═════༫'},
{'تويت','صراحه'},
{'༫═════⛥═════༫'},
{'المطور','انا مين'},
...
local Text ='تم اخت.ر المقطع الصوتي لك'
...
{
{text = '𖠲 اوامر المطورين ??', callback_data="/help5"},{text = '⌯ اوامر الاعضاء ⊁', callback_data="/help6"},
},
{
{text = '𖠲 اوامر التسليه 𖠲', callback_data="/help7"},
},
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عن.🥺🤍](t.me/source_Laren)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان .خد رتبه😹 ](t.me/source_Laren)') 
return false
end
...
if text == 'يوه' then 
send(msg.chat_id_,msg.id_, '[يقتعني يولا  😹💘](t.me/source_Laren)') 
return false
end

if text == '🙂' then 
send(msg.chat_id_,msg.id_, '[متزعلش بحبك 🙂 💘](t.me/source_Laren)') 
return false
end

if text == "نورت"  or text == "نورتي" then

send(msg.chat_id_,msg.id_, '[الروم منور ب. وي بلي في  🌝💘](t.me/source_Laren)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه افضل الصلاة والسلام  💘](t.me/source_Laren)') 
return false
end
end
end

if text == "جيت"  or text == "نجيت" then

send(msg.chat_id_,msg.id_, '[نورت يا عسل 🙂😹](t.me/source_Laren)')
return false
end

if text == "بحبك"  or text == "حبك" then

send(msg.chat_id_,msg.id_, '[موت فيك اسسن . 😹❤️](t.me/source_Laren)')
return false
end

if text == "بيي"  or text == "باي" then

send(msg.chat_id_,msg.id_, '[فده. السكه  الي تودي مترجعشي 😹](t.me/source_Laren)')
return false
end

if text == "برايفت"  or text == "بف" then

send(msg.chat_id_,msg.id_, '[ممكن اجي معاكو وشهعمل صوت 🥺💘](t.me/source_Laren)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انعم الله عليك  💘(t.me/source_Laren)') 
return false
end
end
end

if text == "ايي"  or text == "اي" then

send(msg.chat_id_,msg.id_, '[كتك اوي مش سامع ولا اي  😹](t.me/source_Laren)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عند امك  تيجي معنا نيني😹](t.me/source_Laren)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بت فعينك ياوسخ🙁😹](t.me/source_Laren)') 
return false
end
end
end
...
if text == 'هيفين' or text == 'احمد' then  
local Text = [[  
◍ مطور السورس .
...
if text == 'مرات هيفين' or text == 'اوليف.' then  
local Text = [[  
◍ ستك اوليف. يقلبمك .
◍ روح قلب هيفين .
]]  
