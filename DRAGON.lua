...
𖠲قائمه العام
𖠲 مسح قائمه العام
𖠲 جلب نسخه الاحتياطيه
𖠲 رفع نسخه الاحتياطيه
༫═════⛥═════༫
𖠲اذاعه خاص
𖠲اذاعه
𖠲اذاعه بالتوجيه
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/source_Laren)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/source_Laren)') 
return false
end
...
if text == 'يوه' then 
send(msg.chat_id_,msg.id_, '[يقتعني يولا يا #name 😹💘](t.me/source_Laren)') 
return false
end

if text == '🙂' then 
send(msg.chat_id_,msg.id_, '[متزعلش بحبك. يا #name 🙂 💘](t.me/source_Laren)') 
return false
end

if text == "نورت"  or text == "نورتي" then

send(msg.chat_id_,msg.id_, '[الروم منور بيا وي بلي في يا #name 🌝💘](t.me/source_Laren)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه افضل الصلاة والسلام يا #name 💘](t.me/source_Laren)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نورت ي #name يا عسل 🙂😹](t.me/source_Laren)')
return false
end

if text == "بحبك"  or text == "حبك" then

send(msg.chat_id_,msg.id_, '[موت فيك اسسن يا #name 😹❤️](t.me/source_Laren)')
return false
end

if text == "بيي"  or text == "باي" then

send(msg.chat_id_,msg.id_, '[فدهيا السكه  الي تودي مترجعشي يا #name 😹](t.me/source_Laren)')
return false
end

if text == "برايفت"  or text == "بف" then

send(msg.chat_id_,msg.id_, '[ممكن اجي معاكو وشهعمل صوت يا #name 🥺💘](t.me/source_Laren)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انعم الله عليك يا #name  💘(t.me/source_Laren)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[كتك اوي مش سامع ولا اي يا #name  😹](t.me/source_Laren)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عند امك يا #name تيجي معانا نيني 😹](t.me/source_Laren)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بت فعينك يا #name  يوسخ 🙁😹](t.me/source_Laren)') 
return false
end
end
end
...
if text == 'سايان' or text == 'خالد' then  
local Text = [[  
◍ مطور السورس .
◍ يمكنك التواصل معه عن طريق معرفه .
]]  
