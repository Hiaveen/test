...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Hiaveen/tt/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/Hiaveen/tt/main/DRAGON.lua')
...
usertext = '\n✰︙ العضو » ['..result.title_..'](t.me/'..(username or 'SOURCE_SYRIA')..')'
status  = '\n✰︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✰︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_SYRIA')..') \n✰︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"✰︙ العضو : {["..data.first_name_.."](T.ME/SOURCE_SYRIA)}\n✰︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "✰︙ عذرا » {["..data.first_name_.."](T.ME/SOURCE_SYRIA)}\n✰︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✰︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_SYRIA')..') \n✰︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✰︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCE_SYRIA')..') \n✰︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Hiaveen/tt/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✰︙ اهلا بك في متجر ملفات الوون\n✰︙ ملفات السورس ↓\n⊱⊱════⊱⊱⊱⊱════⊱⊱⊱⊱════⊰⊰\n\n"
local TextE = "\n⊱⊱════⊱⊱⊱⊱════⊱⊱⊱⊱════⊰⊰\n✰︙ علامة تعني { ✔️ } ملف مفعل\n✰︙ علامة تعني { ✖ } ملف معطل\n✰︙ قناة سورس الوون ↓\n".."✰︙ [اضغط هنا لدخول](t.me/SOURCE_SYRIA) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Hiaveen/tt/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✰︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_SYRIA')..')'
status  = '\n✰︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✰︙ العضو » '..userid..''
...
' }\n'..'✰︙  الايدي بالصوره » { '..idph..
' }\n'..'✰︙  الرفع » { '..setadd..
' }\n'..'✰︙  الحظر » { '..banm..' }\n\n⊱⊱════⊱⊱⊱⊱════⊱⊱⊱⊱════⊰⊰\n✰︙ قناة سورس الوون ↓\n [ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙻𝙰𝚁𝙴𝙽 ](t.me/SOURCE_SYRIA) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n✰︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SOURCE_SYRIA')..')'..'\n✰︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
🗯️التاريخ
⊱⊱════⊱⊱⊱⊱════⊱⊱⊱⊱════⊰⊰
[🗯️ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙻𝙰𝚁𝙴𝙽 🗯️](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙻𝙰𝚁𝙴𝙽 ', url="t.me/SOURCE_SYRIA"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂✰](t.me/SOURCE_SYRIA)') 
return false
end
...
{{text = '✰ ❪SＯＵＲＣＥ❫ ✰', url="t.me/SOURCE_SYRIA"}},
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token.. /sendPhoto?chat_id=  .. msg.chat_id_ ..  &photo=https://t.me/Source_Queen&caption=  .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
