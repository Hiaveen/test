...
if text == '/start' then   
if not DRAGON:get(DRAGON..'Start:Time'..msg.sender_user_id_) then
local inline = {{{text="المطور",url="t.me/"..(SudoDRAGON or "source_Laren")}}}
local Sudo_Welcome = '♪يمكنك ايضا استخدام مبرامجين السورس \n♪اليك ازرار يا حكاك اسفل الرساله\n                ❀❀❀❀❀❀❀❀\n                              [Laren](https://t.me/source_Laren)'
local key = {
{'اضغط هنا'},
{'مبرمج السورس'},
{'صاحب السورس'},
...
local start = DRAGON:get(DRAGON.."Start:Bot")
if start then 
Start_Source = start
else
Start_Source = "♪مرحبا انا بوت اسمي { "..name_bot.." }\n♪اختصاصي حماية المجموعات\n♪من التفليش والسبام والخخ .. . ،\n♪قم برفعي ادمن في مجموعتك وارسل ( تفعيل )\n♪سيتم رفع الادمنيه والمنشئ تلقائيا"
end
if text == 'مبرمج السورس' then DRAGON(msg.chat_id_, msg.id_, 1, '[مبرمج السورس««🍟🌿](https://t.me/H_I_v_e_e_n101) ،', 1, 'md') end
if text == 'صاحب التلجرام' then DRAGON(msg.chat_id_, msg.id_, 1, '[صاحب التلجرام««🍟🌿](https://t.me/H_alon) ،', 1, 'md') end
if text == 'اضغط هنا' then DRAGON(msg.chat_id_, msg.id_, 1, ' [Laren](https://t.me/source_Laren) ،\n ،', 1, 'md') end
if text == '•┉ • ┉ • ┉ • ┉ • ┉•' then DRAGON(msg.chat_id_, msg.id_, 1, '♪اختر لعبه من الكيبورد بالاسفل ،', 1, 'md') end
...
if text == 'الاحصائ.ت💘' and DevSoFi(msg) then 
...
send(msg.chat_id_, msg.id_,'💘︙ … عذرآ البوت لايملك صلاح.ت')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
...
༫═════⛥═════༫
𖠲 تفعيل ← تعطيل 
𖠲المجموعات ← المشتركين ← الاحصائ.ت
...
{
{text = '??𝙾𝚄𝚁𝙲𝙴 𝙻𝙰𝚁𝙴𝙽   ', url="t.me/source_Laren"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
