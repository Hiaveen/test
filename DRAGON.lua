...
keyboard.inline_keyboard = {  
{
{text = ' ◍ 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𝙷𝙸𝙰𝚅𝙴𝙴𝙽  𖣌 ',url="t.me/BelalElshayal"}  
},
{
{text = ' ◍ 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𝙼𝙰𝙶𝙴𝙳 𖣌 ',url="t.me/SA_FO_RA_7"}  
},
{
{text = ' ◍ 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𝙺𝙷𝙰𝙻𝙴𝙳 𖣌 ',url="t.me/komanda3b"}  
},
{
{text = ' ◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂 𖣌 ',url="t.me/SOURCE_LAREN"}
}, 
{
{text = '  ²₀²₁ ˝₀₆˝₁₅ | ₆:₀₀ 𝙿𝙼 𖣌 ', url="t.me/SOURCE_LAREN"}  
},
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token.. /sendPhoto?chat_id=  .. msg.chat_id_ ..  &photo=https://t.me/SOURCE_LAREN
