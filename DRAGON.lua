...
if text == "المنشئ" or text == 'المنشئ' then
local UserName = (database:get(bot_id..'UserName') or 'السعودي')
local DRAGON_Msg = {
'هذا  '..UserName..' هو 🤤💚',
}

UserName = DRAGON_Msg[math.random(#DRAGON_Msg)]
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,dp.username_, msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,dp.username_, 1, 'md')
end
end
tdcli_function ({ ID = "ChatMemberStatusCreator", user_id_ = bot_id, offset_ = 0, limit_ = 1 }, getpro, nil)
end
