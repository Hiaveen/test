...
send(msg.chat_id_, msg.id_,'💘︙ اصدار سورس لارين \n💘︙ الاصدار »{ v 1.6 }')
end
...
if text == 'المجموعـات💘' and DevSoFi(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n💘︙ المجموعـات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'جلب نسخه الاحت.طيه💘' and DevSoFi(msg) then 
GetFile_Bot(msg)
end
...
if text == 'رفع نسخه الاحت.طيه' and DevSoFi(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
elseif text == 'فتح تعديل الميد.' and msg.reply_to_message_id_ == 0 and Constructor(msg) then 
...
if text and text:match("^تنزيل مطور زغلول @(.*)$") and SudoBot(msg) then
local username = text:match("^تنزيل مطور زغلول @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
...
if text and text:match("^تنزيل مطور زغلول (%d+)$") and SudoBot(msg) then
local userid = text:match("^تنزيل مطور زغلول (%d+)$")
database:srem(bot_id.."Dev:SoFi:2", userid)
Reply_Status(msg,userid,"reply","℘︙ تم تنزيله من المطورين الزغليل")  
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n💘︙  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'source_Laren')..')'
status  = '\n💘︙  الايدي » `'..result.sender_user_id_..'`\n💘︙  تم تنزيله ادمن من الروم بكل الصلاح.ت'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_,msg.id_,"💘︙ ليست لدي صلاحية التثبيت يرجى التحقق من الصلاح.ت")  
end
end,nil) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '00:00',url="https://t.me/source_Laren"}}, 
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = ' ᴅᴇʟᴇᴛᴇ ᴀɴ ᴀᴄᴄᴏᴜɴᴛ ⤶ ',url="t.me/LC6BOT"}},
{{text = ' ²₀²₁˝₀₆˝₂₁l₁₀:₁₄ ᴘᴍ ⤶   ',url="t.me/source_Laren"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/uu_Qs&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == "صلاح.ته" and tonumber(msg.reply_to_message_id_) > 0 then    
if tonumber(msg.reply_to_message_id_) ~= 0 then 
...
------------------------------------------------------------------------
if text == "صلاح.تي" then 
if tonumber(msg.reply_to_message_id_) == 0 then 
Get_Info(msg,msg.chat_id_,msg.sender_user_id_)
end  
end
------------------------------------------------------------------------
if text and text:match('^صلاح.ته @(.*)') then   
local username = text:match('صلاح.ته @(.*)')   
if tonumber(msg.reply_to_message_id_) == 0 then 
...
local Teext =[[
 مرحبا بك في قائمه اوامر التسليه
 اتبع الازرار إلى تحت في الاسفل ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'م1', callback_data="/mute-name"},
}, 
{
{text = 'م2', callback_data="/sofi"},
},
{
{text = ' 𝚂𝙾𝚄𝚁𝙲𝙴 𝙻𝙰𝚁𝙴𝙽 ', url="t.me/source_Laren"},
},
...
--     By Developer Music     -- 
if text:match("^م1$") or text:match("^م1$") or text:match("^م1$") or  text:match("^م1$") or text:match("^م1$") and faeder11(msg) then 
local inline = {
...
send_inline(msg.chat_id_,'اوامر التسليه 🇪🇬 ،\n🇪🇬 بسورس لارين، ،',nil,inline) 
return false 
end
--     By Developer Music     -- 
if text:match("^م2$") or text:match("^م2$") or text:match("^م2$") or  text:match("^م2$") or text:match("^م2$") and faeder11(msg) then 
local inline = {
{{text="رفع خاين",url="https://t.me/source_Laren"},
{text="رفع خاينه",url="https://t.me/source_Laren"}},
{{text="رفع متخزوق",url="https://t.me/source_Laren"},
{text="رفع عبيط",url="https://t.me/source_Laren"}},
{{text="رفع متوحد",url="https://t.me/source_Laren"},
{text="رفع بقره",url="https://t.me/source_Laren"}},
{{text="رفع غبي",url="https://t.me/source_Laren"},
{text="رفع عره",url="https://t.me/source_Laren"}},
{{text="رفع قرد",url="https://t.me/source_Laren"},
{text="رفع فرسه",url="https://t.me/source_Laren"}},
{{text="رفع علق",url="https://t.me/source_Laren"},
{text="رفع كيرفي",url="https://t.me/source_Laren"}},
{{text="رفع فلات",url="https://t.me/source_Laren"},
{text="قناه البرامجه",url="https://t.me/source_Laren"}},
}
send_inline(msg.chat_id_,'اوامر التسليه الجديده 🇪🇬 ،\n🇪🇬 بسورس لارين، ،',nil,inline) 
return false 
end
...
{{text = 'SkodaHockey1 ', url="https://t.me/gamee?game=SkodaHockey1"},{text = 'SummerLove', url="https://t.me/gamee?game=SummerLove"}},  
{{text = 'SmartUpShark', url="https://t.me/gamee?game=SmartUpShark"},{text = 'SpikyFish3', url="https://t.me/gamee?game=SpikyFish3"}},  
{{text =  ' 00:00 ⤶  ',url="t.me/source_Laren"}},
{{text =  ' ₀²₁˝₀₆˝₂₁l₁₀:₁₄ ᴘᴍ  ⤶  ',url="t.me/source_Laren"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
if text == 'احمد' or text == 'هيفين' then  
local Text = [[  
◍ مطور السورس .
◍ يمكنك التواصل معه عن طريق معرفه .
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = ' 𝙷 𝙸 𝙰 𝚅 𝙴 𝙴 𝙽  ⤶ ',url="t.me/H_I_v_e_e_n101"}},  
{{text = ' ²₀²₁˝₀₆˝₂₁l₁₀:₁₄ ᴘᴍ ⤶   ',url="t.me/source_Laren"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/H_I_v_e_e_n101&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'مرات هيفين' or text == 'اوليفيا' then  
local Text = [[  
◍ ستك اوليفيا يقلبمك .
◍ روح قلب هيفين .
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = ' 𝙾 𝙻 𝙸 𝚅 𝙸 𝙰  ⤶ ',url="t.me/olivia_ana96"}},  
{{text = ' ²₀²₁˝₀₆˝₂₁l₁₀:₁₄ ᴘᴍ ⤶   ',url="t.me/source_Laren"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/olivia_ana96&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'هكر القلوب' or text == 'ماجد' then  
local Text = [[  
◍ مطور السورس .
◍ يمكنك التواصل معه عن طريق معرفه .
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = ' 𝙼 𝙰 𝙶 𝙴 𝙳  ⤶ ',url="t.me/V_C_Z"}},
{{text = ' ²₀²₁˝₀₆˝₂₁l₁₀:₁₄ ᴘᴍ ⤶   ',url="t.me/source_Laren"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/V_C_Z&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'سا.ن' or text == 'خالد' then  
local Text = [[  
◍ مطور السورس .
◍ يمكنك التواصل معه عن طريق معرفه .
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = ' 𝙺 𝙷 𝙰 𝙻 𝙴 𝙳 ⤶ ',url="t.me/UU_K2"}},
{{text = ' ²₀²₁˝₀₆˝₂₁l₁₀:₁₄ ᴘᴍ ⤶   ',url="t.me/source_Laren"}},  
