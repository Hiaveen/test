...
sudo_users = {SUDO,1661260546,1523435687,1360083579,1761406790} 
...
local Text =[[
⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣
[C꯭H꯭-S꯭O꯭U꯭R꯭C꯭E꯭ L꯭A꯭R꯭E꯭N꯭ 🌙💛](t.me/User_Laren)
⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣⍣
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🌖 سلم علي زغلول لم تشوفه ',url="t.me/User_Laren"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/User_Laren&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
return false
end
if DevSoFi(msg) then
...
if #admins == i then 
local a = '\nٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺??𝑹𝑰𝑨 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n✰︙ عدد البوتات التي هنا >> {'..n..'} بوت\n'
...
if text == 'بوت حذف' or text == 'حذف حسابي' or text == 'بوت الحذف' then
local Text = [[
بوت حذف حساب ❅
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/sanforab7)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/sanforab7)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/sanforab7)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/sanforab7)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نورت ياقمر ..🌚❤️](t.me/sanforab7)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/sanforab7)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/sanforab7)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/sanforab7)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/sanforab7)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/sanforab7)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/sanforab7)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/sanforab7)') 
return false
end
end
end
...
if text == 'هكر قلوب' or text == 'ماجد' then  
local Text = [[  
◍ مطور السورس .
◍ يمكنك التواصل معه عن طريق معرفه .
]]  
...
if text == 'سيان' or text == 'خالد' then  
local Text = [[  
◍ مطور السورس .
◍ يمكنك التواصل معه عن طريق معرفه .
]]  
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UU_K2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
