...
var = 'ماجد الهكر'
elseif tonumber(user_id) == tonumber(1767369613) then
var = 'مبرمج سورس'
elseif tonumber(user_id) == tonumber(1761406790) then
var = 'روح قلب هيفين'
elseif tonumber(user_id) == tonumber(SUDO) then
...
send(msg.chat_id_, msg.id_,'✰︙ تم تحديث السورس \n✰︙ لديك اخر اصدار لسورس الوون\n✰︙ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == 'الاصدار✰' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✰︙ اصدار سورس الوون \n✰︙ الاصدار »{ v 1.6 }')
end
...
{
{text = ' ◍ 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𝙷𝙸𝙰𝚅𝙴𝙴𝙽  ', url = "https://t.me/User_Laren"},{text = '◍ 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𝙼𝙰𝙶𝙴𝙳 ', url = "https://t.me/User_Laren"},
},
{
{text = '◍ 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𝙺𝙷𝙰𝙻𝙴𝙳', url = "https://t.me/User_Laren"},
},
{
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sanforab7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"✰︙ عذرا الملف لايدعم سورس الوون \n") 
end
return false
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀.',url="t.me/SOURCE_LAREN"}},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '𝙻𝙰𝚁𝙴𝙽 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ', url="t.me/SOURCE_LAREN"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
🍁الاشعارات
⊱⊱════⊱⊱⊱⊱════⊱⊱⊱⊱════⊰⊰
[🍁𝚂𝙾𝚄𝚁𝙲𝙴 𝙻𝙰𝚁𝙴𝙽  𓏴  🍁](t.me/SOURCE_LAREN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🍁صورتي 
⊱⊱════⊱⊱⊱⊱════⊱⊱⊱⊱════⊰⊰
[🍁𝚂𝙾𝚄𝚁𝙲𝙴 𝙻𝙰𝚁𝙴𝙽  𓏴  ⚡️](t.me/SOURCE_LAREN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🗯️التاريخ
⊱⊱════⊱⊱⊱⊱════⊱⊱⊱⊱════⊰⊰
[🗯️ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙻𝙰𝚁𝙴𝙽  𓏴  🗯️](t.me/SOURCE_LAREN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙾𝙻𝙸𝚅𝙸𝙰 🇦🇮 ',url="t.me/olivia_ana96"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
