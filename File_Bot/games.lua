...
⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 
〩 ╾╾╾╾╾╾╾╾╾╾╾╸〩
𖤛أنت الآن في العاب السورس𖤛
〩 ╾╾╾╾╾╾╾╾╾╾╾╸〩
𖤛اوامر الالعاب كتالي 
〩 ╾╾╾╾╾╾╾╾╾╾╾╸〩
 𖤛تفعيل الالعاب • لتفعيل العبه ° 
 𖤛تعطيل الالعاب • لتعطيل العبه °
〩 ╾╾╾╾╾╾╾╾╾╾╾╸〩
 𖤛الالعاب الخاصه بسورس 
〩 ╾╾╾╾╾╾╾╾╾╾╾╸〩
 𖤛لعبه البات ~⪼ لعبة المحيبس 
 𖤛لعبه التخمين ~⪼ لعبة البحث
 𖤛لعبه الاسرع ~⪼ لعبة اسرع شخص
 𖤛لعبه السمايلات ~⪼ لعبة المطابقه 
 𖤛لعبه المختلف ~⪼ لعبة الذكاء
 𖤛لعبه الرياضيات ~⪼ لعبة الارقام
 𖤛لعبه الانكليزي ~⪼ لعبة ترجمه
 𖤛لعبه الامثله ~⪼ لعبة تصحيح 
 𖤛لعبه العكس ~⪼ لعبة عكس الكلمات
 𖤛لعبه الحزوره ~⪼لعبة التفكير 
 𖤛لعبه المعاني ~⪼ العبه الشهيره 
〩 ╾╾╾╾╾╾╾╾╾╾╾╸〩
]]
keyboard = {} 
...
send(msg.chat_id_, msg.id_,' 𖤛اسرع واحد يدز هاذا السمايل ? » {`'..SM..'`}')
return false
end
end
...
send(msg.chat_id_, msg.id_,' 𖤛الف مبروك لقد فزت \n 𖤛للعب مره اخره ارسل »{ سمايل , سمايلات }')
...
send(msg.chat_id_, msg.id_,' 𖤛اسرع واحد يرتبها » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤛الف مبروك لقد فزت \n 𖤛للعب مره اخره ارسل »{ الاسرع , ترتيب }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' 𖤛اسرع واحد يحل الحزوره ↓\n {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤛اسرع واحد يدز معنى السمايل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤛 الف مبروك لقد فزت \n 𖤛للعب مره اخره ارسل »{ معاني }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' 𖤛اسرع واحد يدز العكس » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," 𖤛عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,' 𖤛مبروك فزت ويانه وخمنت الرقم الصحيح\n 𖤛تم اضافة { 5 } من النقاط \n')
...
database:del(bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖤛اوبس لقد خسرت في اللعبه \n 𖤛حظآ اوفر في المره القادمه \n 𖤛كان الرقم الذي تم تخمينه { '..GETNUM..' }')
else
send(msg.chat_id_, msg.id_,' 𖤛اوبس تخمينك غلط \n 𖤛ارسل رقم تخمنه مره اخرى ')
end
end
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖤛اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..' 𖤛ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..' 𖤛سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ')
...
send(msg.chat_id_, msg.id_," 𖤛عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖤛مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n 𖤛لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖤛للاسف لقد خسرت \n 𖤛المحيبس بل ايد رقم { '..GETNUM..' }\n 𖤛حاول مره اخرى للعثور على المحيبس')
end
end
end
...
↓      ↓     ↓      ↓     ↓     ↓   
👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊
 𖤛اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
 𖤛الفائز يحصل على { 3 } من النقاط *
]]
...
name = string.gsub(name,'⌛️','⏳⏳⏳⏳⏳⏳⌛️⏳⏳')
name = string.gsub(name,'📅','📆📆📆📆📆📆📅📆📆')
send(msg.chat_id_, msg.id_,' 𖤛اسرع واحد يدز الاختلاف » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤛حل المسأله الرياضيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤛ترجم الكلمات الاتيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤛اسرع واحد يكمل المثل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤛الف مبروك لقد فزت \n 𖤛للعب مره اخره ارسل »{ امثله }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id..'Set:Amth:Bot'..msg.chat_id_,true)
end
if text == ' العاب لارين' or text == 'الالعاب المتطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/source_Laren/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
